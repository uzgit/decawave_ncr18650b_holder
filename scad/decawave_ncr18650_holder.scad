...
module box() {
	...
	difference() {
        ...
        // Screw holes
		translate([(box_Screw_Corner_Radius+box_Wall_Thickness)/2,(box_Screw_Corner_Radius+box_Wall_Thickness)/2,0]) nutHole(3);
		translate([(box_Screw_Corner_Radius+box_Wall_Thickness)/2,box_Size_Y-(box_Screw_Corner_Radius+box_Wall_Thickness)/2,0]) nutHole(3);
		translate([box_Size_X-(box_Screw_Corner_Radius+box_Wall_Thickness)/2,(box_Screw_Corner_Radius+box_Wall_Thickness)/2,0]) nutHole(3);
		translate([box_Size_X-(box_Screw_Corner_Radius+box_Wall_Thickness)/2,box_Size_Y-(box_Screw_Corner_Radius+box_Wall_Thickness)/2,0]) nutHole(3);
...
union()
{
    ...
    {
        box();
//        translate([11.15, 7.92, 0])
        translate([43.5, 20, 12])
        rotate([0, 0, 90])
        import("../stl/ncr18650_holder.stl");
        
    // board dimensions 44x62
    $fn=60;
    translate([41, 60, 0])
